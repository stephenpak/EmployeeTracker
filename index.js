    ...
    .then((res) => {
      db.query(
        ...
        (err, res) => {
          if (err) throw err;
          console.log(
            `Department added! Select "view all departments" to see addition.`
          );
          promptUser();
        }
      );
  ...
  db.query('SELECT * FROM department', (err, res) => {
    ...
    inquirer
      ...
      .then((data) => {
        ...
        const depID = res.find(
          (department) => department.dep_name === data.depID
        );
        db.query(
          ...
          (err) => {
            ...
            console.log(
              `Role successfully added. Select "view all roles" to see addition`
            );
            promptUser();
          }
        );
    ...
    .then((res) => {
      db.query(
        ...
        (err, res) => {
          if (err) throw err;
          console.log(
            `New Employee added! Select "view all employees" to see addition.`
          );
          promptUser();
        }
      );
    ...
    function (err, res) {
      ...
      inquirer
        ...
        .then((res) => {
          ...
          db.query(
            `SELECT role_table.title AS Role_Title FROM role_table`,
            function (err, res) {
              if (err) throw err;
              ...
              inquirer
                ...
                .then((res) => {
                  ...
                  db.query(
                    `UPDATE employees SET ? WHERE CONCAT(employees.first_name,' ', employees.last_name) = '${employee}'; `,
                    {
